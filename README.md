# Overview
This is the artifact that is used to evaluate OrbitCache, as described in the paper "NetClone: Fast, Scalable, and Dynamic Request Cloning for Microsecond-Scale RPCs" in ACM SIGCOMM 2023.
...
4. Compile `netclone.p4` using the P4 compiler (we used `p4build.sh` provided by Intel). You can compile it manually with the following commands.
   ...
   ```
root@tofino:/home/tofino/bf-sde-9.7.0# cmake ${SDE}/p4studio -DCMAKE_INSTALL_PREFIX=${SDE_INSTALL} -DCMAKE_MODULE_PATH=${SDE}/cmake -DP4_NAME=starcache -DP4_PATH=${SDE}/starcache.p4
-- 
P4_LANG: p4-16
...
P4_NAME: starcache
-- 
P4_PATH: /home/tofino/bf-sde-9.7.0/starcache.p4
-- Configuring done
-- Generating done
...
[100%] Generating starcache/tofino/bf-rt.json
/home/tofino/bf-sde-9.7.0/starcache.p4(681): [--Wwarn=unused] warning: Table get_acked_table is not used; removing
    table get_acked_table{
          ^^^^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(700): [--Wwarn=unused] warning: Table update_acked_table is not used; removing
    table update_acked_table{
          ^^^^^^^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(732): [--Wwarn=unused] warning: Table inc_total_overflow_table is not used; removing
    table inc_total_overflow_table{
          ^^^^^^^^^^^^^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(661): [--Wwarn=unused] warning: get_acked: unused instance
    RegisterAction<bit<8>, _, bit<8>>(acked) get_acked = {
                                             ^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(689): [--Wwarn=unused] warning: update_acked: unused instance
     RegisterAction<bit<8>, _, bit<8>>(acked) update_acked = {
                                              ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(721): [--Wwarn=unused] warning: inc_total_overflow: unused instance
    RegisterAction<bit<32>, _, bit<32>>(total_overflow) inc_total_overflow = {
                                                        ^^^^^^^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(170): [--Wwarn=uninitialized_out_param] warning: out parameter 'ig_md' may be uninitialized when 'SwitchIngressParser' terminates
        out metadata_t ig_md,
                       ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(167)
parser SwitchIngressParser(
       ^^^^^^^^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(284): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(284)
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(406): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<8> reg_value, out bit<8> return_value) {
                                                      ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(406)
        void apply(inout bit<8> reg_value, out bit<8> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(412): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<8> reg_value, out bit<8> return_value) {
                                                      ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(412)
        void apply(inout bit<8> reg_value, out bit<8> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(509): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(509)
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(552): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<16> reg_value, out bit<16> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(552)
        void apply(inout bit<16> reg_value, out bit<16> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(573): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(573)
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(592): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(592)
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(635): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(635)
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(654): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(654)
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(690): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<8> reg_value, out bit<8> return_value) {
                                                      ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(690)
        void apply(inout bit<8> reg_value, out bit<8> return_value) {
             ^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(722): [--Wwarn=uninitialized_out_param] warning: out parameter 'return_value' may be uninitialized when 'apply' terminates
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
                                                        ^^^^^^^^^^^^
/home/tofino/bf-sde-9.7.0/starcache.p4(722)
        void apply(inout bit<32> reg_value, out bit<32> return_value) {
             ^^^^^
[100%] Built target starcache-tofino
[100%] Built target starcache
...
-- Installing: /home/tofino/bf-sde-9.7.0/install/share/p4/targets/tofino/starcache.conf
-- Up-to-date: /home/tofino/bf-sde-9.7.0/install/share/tofinopd/starcache
-- Up-to-date: /home/tofino/bf-sde-9.7.0/install/share/tofinopd/starcache/pipe
-- Installing: /home/tofino/bf-sde-9.7.0/install/share/tofinopd/starcache/pipe/tofino.bin
-- Installing: /home/tofino/bf-sde-9.7.0/install/share/tofinopd/starcache/pipe/context.json
-- Installing: /home/tofino/bf-sde-9.7.0/install/share/tofinopd/starcache/events.json
-- Installing: /home/tofino/bf-sde-9.7.0/install/share/tofinopd/starcache/source.json
-- Installing: /home/tofino/bf-sde-9.7.0/install/share/tofinopd/starcache/bf-rt.json
